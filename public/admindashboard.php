...
// User count 
$query="SELECT id FROM registerlist";
...
$blog=mysqli_num_rows($blogresult);
...
$category=mysqli_num_rows($categoryresult);
// category count 

// comment count 
$query="SELECT id FROM comment";
$commentresult=mysqli_query($db,$query);
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                ?>
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small fw-bolder fs-5 text-uppercase"><?php echo $name['name']; ?></span>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1 fs-4">
                                                CATEGORIES</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800 fs-3"><?php echo $category; ?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1 fs-4">
                                                Blogs</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800 fs-3"><?php echo $blog; ?></div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1 fs-4">Users
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800 fs-3"><?php echo $user;?></div>
                                                </div>
                                                <div class="col">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            Comments</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800 fs-3"><?php echo $comment; ?></div>
                                        </div>
                                        <div class="col-auto">
