                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-title bg-light d-flex  justify-content-between">
                            <h4 class="p-3 text-primary fw-bold">Category list</h4>
                            <div class="my-3 mx-3 "><a href="categorycreate.php" class="btn btn-primary float-right" > + Add New</a></div>
                        </div>
                        <div class="card-body">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       <a href="categoryedit.php?editid=<?php  echo $category['id'];?>"><button class="btn btn-success" ><i class='fa fa-edit'></i></button></a>
                                       <a href="category.php?deleteid=<?php  echo $category['id'];?>"><button class="btn btn-danger" onclick="return confirm('Are You Sure You Want To Delete'); "><i class='fa fa-trash'></i></button></a>
