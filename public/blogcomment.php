                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-title bg-light d-flex  justify-content-between">
                            <h4 class="p-3 text-primary fw-bold">Comment list</h4>
                        ...
                        <div class="card-body">
                           ...
                           <table class="table table-bordered" >
                                ...
                                <?php 
                                    ...
                                    foreach($cmt as $cmtresult){


                                        ?>
                                <tr>
                                    <td><?php echo $cmtresult['id']; ?></td>
                                    <td><?php echo $cmtresult['message']; ?></td>
                                    <td><?php echo $cmtresult['name']; ?></td>
                                    <td><?php echo $cmtresult['cmttime']; ?></td>
                                </tr>
                                <?php
                                    }
                                ?>
