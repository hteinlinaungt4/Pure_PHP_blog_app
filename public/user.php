...
if ($_GET['delete']) {
    $id=$_GET['delete'];
    $query="DELETE FROM registerlist WHERE id='$id'";
    mysqli_query($db,$query);
}
?>
<!DOCTYPE html>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-title bg-light d-flex  justify-content-between">
                            <h4 class="p-3 text-primary fw-bold">User list</h4>
                        </div>
                        <div class="card-body">
                           ...
                           <table class="table table-bordered" >
                                ...
                                <?php 
                                    $query="SELECT * FROM registerlist";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="useredit.php?id=<?php echo $blog['id']; ?>"><button class="btn btn-success" ><i class='fa fa-edit'></i></button></a>
                                       <a href="user.php?delete=<?php echo $blog['id']; ?>"><button class="btn btn-danger" onclick="return confirm('Are You Sure You Want To Delete'); "><i class='fa fa-trash'></i></button></a> 
