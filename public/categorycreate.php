...
if (isset($_POST['submit'])) {
  ...
  if(!empty($name)){
    ...
    $_SESSION['successMsg']="You are created successfully category!";
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-title bg-light d-flex  justify-content-between">
                            <h4 class="p-3 text-primary fw-bold">Category Creation Form</h4>
                        ...
                        <div class="card-body">
                            <form class="form" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?php if(!empty($nameError)): ?>is-invalid<?php endif; ?>" id="name" name="name" >
